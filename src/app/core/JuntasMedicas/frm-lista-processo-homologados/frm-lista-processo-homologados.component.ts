...
@Component({
  selector: 'app-frm-lista-processo-homologados',
  templateUrl: './frm-lista-processo-homologados.component.html',
  styleUrl: './frm-lista-processo-homologados.component.scss',
...
export class FrmListaProcessoHomologadosComponent
