...
@Component({
  selector: 'app-frm-lista-processo-homo-naologados',
  templateUrl: './frm-lista-processo-homo-naologados.component.html',
  styleUrl: './frm-lista-processo-homo-naologados.component.scss',
...
export class FrmListaProcessoHomoNaologadosComponent
