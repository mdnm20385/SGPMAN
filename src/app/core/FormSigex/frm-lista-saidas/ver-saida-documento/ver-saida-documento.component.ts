...
@Component({
  selector: 'app-ver-saida-documento',
  ...
  templateUrl: './ver-saida-documento.component.html',
  styleUrl: './ver-saida-documento.component.scss'
})
export class VerSaidaDocumentoComponent
