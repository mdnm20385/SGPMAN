...
@Component({
  selector: 'app-frm-modal-orgao',
  templateUrl: './frm-modal-orgao.component.html',
  styleUrl: './frm-modal-orgao.component.scss',
  standalone: true,
  imports: [
    MatDialogModule,
    MatButtonModule,
...
export class FrmModalOrgaoComponent implements OnInit {
  ...
  login() {
    ...
    if (
      this.registerForm.get('orgaoStamp')!.value === null ||
      this.registerForm.get('orgaoStamp')!.value === undefined ||
      this.registerForm.get('orgaoStamp')!.value === typeof undefined ||
      this.registerForm.get('orgaoStamp')!.value.length == 0
    ) {
      this.registerForm.patchValue({
