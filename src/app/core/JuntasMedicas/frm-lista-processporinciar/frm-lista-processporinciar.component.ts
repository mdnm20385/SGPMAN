...
@Component({
  selector: 'app-frm-lista-processporinciar',
  templateUrl: './frm-lista-processporinciar.component.html',
  styleUrl: './frm-lista-processporinciar.component.scss',
...
export class FrmListaProcessporinciarComponent
...
if(this.params.q.length>0){
  ...
  const proc: Procura = {
    ...
    descricao: '',
    origem: '',
    referencia: ` not in('sim' ,'EM TRAMITAÇÃO','NÃO')`,
    usuario
  };
  this.remoteSrv
  .MetodoGenerico(proc)
