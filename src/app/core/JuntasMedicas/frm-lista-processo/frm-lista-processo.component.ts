...
@Component({
  selector: 'app-frm-lista-processo',
  templateUrl: './frm-lista-processo.component.html',
  styleUrl: './frm-lista-processo.component.scss',
...
export class FrmListaProcessoComponent
...
//Nome,Sexo,NumBi,ResProv,ConPrinc,ConAlter,Patente
  ...
  ngOnInit() {
    ...
    this.route.queryParams.subscribe(params => {
      // console.log(`Id = ${params.id}`);   // 123
      // console.log(`Nome = ${params.nome}`); // teste
    });
